...
'''  en2.py
     This Python file creates a variable called essay_en2
...
essay_en2 = """Astronaut Survives 9.5 Months with No Pizza
...
Having completed her third long-duration voyage on the International Space Station, Peggy "still can’t believe the incredible level of detail that was required to imagine this place, let alone to build it!"
